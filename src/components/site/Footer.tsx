        ...
        <div className="grid gap-12 md:grid-cols-12">
          <div className="md:col-span-5">
            ...
            <p className="mt-6 max-w-md text-sm leading-relaxed text-primary-foreground/70">
              A trusted name in timber processing since {COMPANY.established}. Serving
              construction, furniture, interior design and industrial clients with
              precision-cut wood products and reliable bulk supply.
            </p>
            <div className="mt-8 space-y-3 text-sm">
              <a href={`tel:${COMPANY.phone}`} className="flex items-center gap-3 text-primary-foreground/80 hover:text-white">
                <Phone className="h-4 w-4 text-highlight" /> {COMPANY.phone}
              </a>
              <a href={`mailto:${COMPANY.email}`} className="flex items-center gap-3 text-primary-foreground/80 hover:text-white">
          ...
          <div className="md:col-span-3">
            ...
            <Link to="/contact" className="link-arrow mt-8 text-primary-foreground hover:text-highlight">
