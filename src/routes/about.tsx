  ...
  head: () => ({
    meta: [
      { title: "About — Savitri Saw Mill" },
      {
        name: "description",
        content:
          "Four decades of timber craft. Our story, mission, values and the people behind Savitri Saw Mill.",
      },
...
const VALUES = [
  {
    t: "Integrity",
    b: "We quote what we can deliver. Every cubic meter is traceable from log to dispatch.",
  },
  {
    t: "Craft",
    b: "Our master sawyers have logged 20+ years on the floor. Tools change. Judgement compounds.",
  },
  {
    t: "Precision",
    b: "Calibrated daily. Inspected at three stages. ±0.5 mm tolerance on custom cuts.",
  },
  {
    t: "Reliability",
    b: "Lead times we honour. Dispatch slots we keep. Paperwork that's ready when you are.",
  },
];

const TIMELINE = [
  { y: "1987", t: "Founded", b: "Single saw, two-person operation serving Hyderabad builders." },
  {
    y: "1998",
    t: "First Kiln",
    b: "Installed our first kiln dryer — moisture-controlled stock becomes a regional differentiator.",
  },
  {
    y: "2008",
    t: "Twin Band Mill",
    b: "Upgraded to twin band mills, tripling daily output capacity.",
  },
  {
    y: "2016",
    t: "CNC Profiling",
    b: "Added CNC-assisted profiling for custom industrial contracts.",
  },
  { y: "2021", t: "Export Grade", b: "ISPM-15 certification for heat-treated export packaging." },
  {
    y: "2025",
    t: "Today",
    b: "120 m³ daily output. 650+ active B2B accounts. Pan-India delivery.",
  },
];
        ...
        <div className="container-x grid gap-12 lg:grid-cols-12">
          ...
          <Reveal delay={0.15} className="lg:col-span-5 lg:pt-8">
            <p className="text-lg leading-relaxed text-white/75">
              For nearly four decades, Savitri Saw Mill has supplied the contractors, architects and
              manufacturers who can't afford a wrong cut. This is who we are, what we believe, and
              how we got here.
            </p>
          </Reveal>
        </div>
        ...
        <div className="container-x grid gap-16 lg:grid-cols-12">
          ...
          <Reveal delay={0.1} className="lg:col-span-6 lg:pt-8">
            ...
            <div className="mt-8 space-y-4 text-base leading-relaxed text-muted-foreground">
              <p>
                Savitri Saw Mill was started in 1987 by Mr. Rameshwar Saw — a master sawyer with a
                stubborn belief that timber should arrive ready to install. No warps. No rework. No
                excuses.
              </p>
              <p>
              ...
              <p>
                Today the company is run by the next generation, but the standard hasn't moved. We
                still measure twice. We still grade every log. And we still answer the phone.
              </p>
            </div>
          </Reveal>
        </div>
      ...
      <section className="bg-muted py-24 md:py-32">
        <div className="container-x grid gap-12 md:grid-cols-3">
          {[
            {
              t: "Vision",
              b: "To be the most trusted timber manufacturer in central India — known for precision, reliability and ethical sourcing.",
            },
            {
              t: "Mission",
              b: "Engineer timber products that arrive square, stable and on spec — so our clients can build without compromise.",
            },
            {
              t: "Philosophy",
              b: "Industry-grade machinery, generation-deep craft, and zero tolerance for shortcuts.",
            },
          ].map((c, i) => (
        ...
        <div className="container-x">
          <Reveal>
            ...
            <h2 className="display-lg mt-6 max-w-2xl">
              Four words we test ourselves against, every day.
            </h2>
          </Reveal>
            ...
            <div className="space-y-12">
              {TIMELINE.map((t, i) => (
                <Reveal key={t.y} delay={i * 0.05}>
                  ...
                  >
                    <div
                      className={`pl-12 md:pl-0 ${i % 2 ? "md:text-left md:pl-12" : "md:text-right md:pr-12"} relative`}
                    >
                      <span
                        className="absolute left-0 md:left-auto md:right-[-9px] top-1 grid h-4 w-4 md:right-auto place-items-center"
                    ...
                    <div
                      className={`pl-12 md:pl-12 ${i % 2 ? "md:pl-0 md:pr-12 md:text-right" : ""}`}
                    >
      ...
      <section className="bg-muted py-20">
        <div className="container-x grid gap-8 md:grid-cols-3 items-center">
          <div className="md:col-span-2">
            ...
            <h3 className="display-md mt-4">Pan-India delivery, headquartered in Hyderabad.</h3>
          </div>
          <div className="text-sm text-muted-foreground">
            Primary catchment: Telangana, Andhra Pradesh, Maharashtra, Karnataka. Bulk orders
            shipped nationwide via in-house fleet and verified logistics partners. Export packaging
            available on request from {COMPANY.address.split(",").slice(-3).join(", ")}.
          </div>
        </div>
